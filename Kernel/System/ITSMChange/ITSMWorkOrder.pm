...
sub WorkOrderAdd {
    ...
    for my $Argument (qw(Instruction Report)) {
        ...
        # Upgrade to utf-8 in order to comply to the OTOBO-convention.
...
sub WorkOrderPossibleStatesGet {
    ...
    if ( $Param{WorkOrderID} ) {
        ...
        my $WorkOrderEndStatesAllowed = $Kernel::OM->Get('Kernel::Config')->Get('ITSMWorkOrder::StateLock::AllowEndStates');
