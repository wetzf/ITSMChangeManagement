...
This method replaces all the <OTOBO_xxxx> macros in notification text.

    my $CleanText = $NotificationObject->_NotificationReplaceMacros(
        Type      => 'Change',    # Change|WorkOrder
        Text      => 'Some <OTOBO_CONFIG_FQDN> text',
...
sub _NotificationReplaceMacros {
    ...
    $Text =~ s{ $Start OTOBO_FIRST_NAME $End }{$CurrentUser{UserFirstname}}gxms;
    $Text =~ s{ $Start OTOBO_LAST_NAME $End }{$CurrentUser{UserLastname}}gxms;
    ...
    # replace <OTOBO_CHANGE_... tags
    {
        my $Tag = $Start . 'OTOBO_CHANGE_';
        ...
        # <OTOBO_CHANGE_DynamicField_NameX> returns the stored key
        # <OTOBO_CHANGE_DynamicField_NameX_Value> returns the display value
    ...
    # replace <OTOBO_WORKORDER_... tags
    {
        my $Tag = $Start . 'OTOBO_WORKORDER_';
        ...
        # Dropdown, Checkbox and MultipleSelect DynamicFields, can store values (keys) that are
        # different from the the values to display
        # <OTOBO_WORKORDER_DynamicField_NameX> returns the stored key
        # <OTOBO_WORKORDER_DynamicField_NameX_Value> returns the display value
    ...
    # replace <OTOBO_CONDITION... tags
    {
        my $Tag  = $Start . 'OTOBO_CONDITION_';
        my %Data = %{ $Param{Data} };
    ...
    # replace <OTOBO_LINK_... tags
    {
        my $Tag      = $Start . 'OTOBO_LINK_';
...
=head3 C<OTOBO_CHANGEBUILDER_xxx>, C<OTOBO_CHANGEMANAGER_xxx>, C<OTOBO_WORKORDERAGENT_xxx>
