...
sub _AddNotifications {
    ...
    my $ChangeInfoAgentEn = "\n"
        . "\n"
        . "Change title: <OTOBO_CHANGE_ChangeTitle>\n"
        . "Change builder: <OTOBO_CHANGE_ChangeBuilder>\n"
        . "Change manager: <OTOBO_CHANGE_ChangeManager>\n"
        . "Current change state: <OTOBO_CHANGE_ChangeState>\n"
        . "\n"
        . "<OTOBO_CONFIG_HttpType>://<OTOBO_CONFIG_FQDN>/<OTOBO_CONFIG_ScriptAlias>index.pl?Action=AgentITSMChangeZoom;ChangeID=<OTOBO_CHANGE_ChangeID>\n"
        . "\n"
    ...
    my $ChangeInfoAgentDe = "\n"
        . "\n"
        . "Change Titel: <OTOBO_CHANGE_ChangeTitle>\n"
        . "Change-Builder: <OTOBO_CHANGE_ChangeBuilder>\n"
        . "Change-Manager: <OTOBO_CHANGE_ChangeManager>\n"
        . "Aktueller Change Status: <OTOBO_CHANGE_ChangeState>\n"
        . "\n"
        . "<OTOBO_CONFIG_HttpType>://<OTOBO_CONFIG_FQDN>/<OTOBO_CONFIG_ScriptAlias>index.pl?Action=AgentITSMChangeZoom;ChangeID=<OTOBO_CHANGE_ChangeID>\n"
        . "\n"
        . "-- <OTOBO_CONFIG_NotificationSenderName>\n";
    ...
    my $ChangeInfoAgentHu = "\n"
        . "\n"
        . "Változáscím: <OTOBO_CHANGE_ChangeTitle>\n"
        . "Változás-összeállító: <OTOBO_CHANGE_ChangeBuilder>\n"
        . "Változásmenedzser: <OTOBO_CHANGE_ChangeManager>\n"
        . "Jelenlegi változásállapot: <OTOBO_CHANGE_ChangeState>\n"
        . "\n"
        . "<OTOBO_CONFIG_HttpType>://<OTOBO_CONFIG_FQDN>/<OTOBO_CONFIG_ScriptAlias>index.pl?Action=AgentITSMChangeZoom;ChangeID=<OTOBO_CHANGE_ChangeID>\n"
        . "\n"
        . "-- <OTOBO_CONFIG_NotificationSenderName>\n";
    ...
    my $ChangeInfoAgentNl = "\n"
        ...
        . "Change-Builder: <OTOBO_CHANGE_ChangeBuilder>\n"
        . "Change-Manager: <OTOBO_CHANGE_ChangeManager>\n"
        . "Actuele change-status: <OTOBO_CHANGE_ChangeState>\n"
        . "\n"
        . "<OTOBO_CONFIG_HttpType>://<OTOBO_CONFIG_FQDN>/<OTOBO_CONFIG_ScriptAlias>index.pl?Action=AgentITSMChangeZoom;ChangeID=<OTOBO_CHANGE_ChangeID>\n"
        . "\n"
        . "-- <OTOBO_CONFIG_NotificationSenderName>\n";
    ...
    my $WorkOrderInfoCustomerEn = "\n"
        ...
        . "Current change state: <OTOBO_CHANGE_ChangeState>\n"
        . "\n"
        . "Workorder title: <OTOBO_WORKORDER_WorkOrderTitle>\n"
        . "Workorder type: <OTOBO_WORKORDER_WorkOrderType>\n"
        . "Workorder agent: <OTOBO_WORKORDER_WorkOrderAgent>\n"
        . "Current workorder state: <OTOBO_WORKORDER_WorkOrderState>\n"
        . "\n"
        . "-- <OTOBO_CONFIG_NotificationSenderName>\n";
    ...
    my $WorkOrderInfoAgentEn = "\n"
        ...
        . "Current workorder state: <OTOBO_WORKORDER_WorkOrderState>\n"
        . "\n"
        . "<OTOBO_CONFIG_HttpType>://<OTOBO_CONFIG_FQDN>/<OTOBO_CONFIG_ScriptAlias>index.pl?Action=AgentITSMWorkOrderZoom;WorkOrderID=<OTOBO_WORKORDER_WorkOrderID>\n"
        . "\n"
        . "-- <OTOBO_CONFIG_NotificationSenderName>\n";
    ...
    my $WorkOrderInfoAgentDe = "\n"
        ...
        . "Aktueller Change Status: <OTOBO_CHANGE_ChangeState>\n"
        . "\n"
        . "Workorder Titel: <OTOBO_WORKORDER_WorkOrderTitle>\n"
        . "Workorder Typ: <OTOBO_WORKORDER_WorkOrderType>\n"
        . "Workorder Agent: <OTOBO_WORKORDER_WorkOrderAgent>\n"
        . "Aktueller Workorder Status: <OTOBO_WORKORDER_WorkOrderState>\n"
        . "\n"
        . "<OTOBO_CONFIG_HttpType>://<OTOBO_CONFIG_FQDN>/<OTOBO_CONFIG_ScriptAlias>index.pl?Action=AgentITSMWorkOrderZoom;WorkOrderID=<OTOBO_WORKORDER_WorkOrderID>\n"
        . "\n"
        . "-- <OTOBO_CONFIG_NotificationSenderName>\n";
    ...
    my $WorkOrderInfoCustomerHu = "\n"
        ...
        . "Jelenlegi változásállapot: <OTOBO_CHANGE_ChangeState>\n"
        . "\n"
        . "Munkamegrendelés-cím: <OTOBO_WORKORDER_WorkOrderTitle>\n"
        . "Munkamegrendelés-típus: <OTOBO_WORKORDER_WorkOrderType>\n"
        . "Munkamegrendelés-ügyintéző: <OTOBO_WORKORDER_WorkOrderAgent>\n"
        . "Jelenlegi munkamegrendelés-állapot: <OTOBO_WORKORDER_WorkOrderState>\n"
        . "\n"
        . "-- <OTOBO_CONFIG_NotificationSenderName>\n";
    ...
    my $WorkOrderInfoAgentNl = "\n"
        ...
        . "Actuele change-status: <OTOBO_CHANGE_ChangeState>\n"
        . "\n"
        . "Work Order-titel: <OTOBO_WORKORDER_WorkOrderTitle>\n"
        . "Work Order-type: <OTOBO_WORKORDER_WorkOrderType>\n"
        . "Work Order-agent: <OTOBO_WORKORDER_WorkOrderAgent>\n"
        . "Actuele Work Order-status: <OTOBO_WORKORDER_WorkOrderState>\n"
        . "\n"
        . "<OTOBO_CONFIG_HttpType>://<OTOBO_CONFIG_FQDN>/<OTOBO_CONFIG_ScriptAlias>index.pl?Action=AgentITSMWorkOrderZoom;WorkOrderID=<OTOBO_WORKORDER_WorkOrderID>\n"
        . "\n"
        . "-- <OTOBO_CONFIG_NotificationSenderName>\n";
    ...
    my @Notifications = (
        {
            ...
            Message   => {
                Agent => {
                    de => {
                        Subject => '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] neu erstellt',
                        Body    => '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> wurde neu erstellt.'
                            . $ChangeInfoAgentDe,
                        ContentType => 'text/plain',
                    },
                    en => {
                        Subject => '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] created',
                        Body    => '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> was created.'
                            . $ChangeInfoAgentEn,
                        ContentType => 'text/plain',
                    },
                    hu => {
                        Subject => '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] létrehozva',
                        Body =>
                            'Létrejött a következő változás: <OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>.'
                            . $ChangeInfoAgentHu,
                        ContentType => 'text/plain',
                    },
                    nl => {
                        Subject => '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] aangemaakt',
                        Body    => '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> is aangemaakt.'
                            . $ChangeInfoAgentNl,
                        ContentType => 'text/plain',
                    },
                },
        ...
        },
        {
            ...
            Message   => {
                Agent => {
                    de => {
                        Subject => '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] aktualisiert',
                        Body    => '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> wurde aktualisiert.'
                            . $ChangeInfoAgentDe,
                        ContentType => 'text/plain',
                    },
                    en => {
                        Subject => '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] updated',
                        Body    => '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> was updated.'
                            . $ChangeInfoAgentEn,
                        ContentType => 'text/plain',
                    },
                    hu => {
                        Subject => '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] frissítve',
                        Body =>
                            'Frissült a következő változás: <OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>.'
                            . $ChangeInfoAgentHu,
                        ContentType => 'text/plain',
                    },
                    nl => {
                        Subject => '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] bijgewerkt',
                        Body    => '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> is bijgewerkt.'
                            . $ChangeInfoAgentNl,
                        ContentType => 'text/plain',
                    },
                },
        ...
        },
        {
            ...
            Message   => {
                Agent => {
                    de => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] neu erstellt',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> wurde neu erstellt.'
                            . $WorkOrderInfoAgentDe,
                        ContentType => 'text/plain',
                    },
                    en => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] created',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> was created.'
                            . $WorkOrderInfoAgentEn,
                        ContentType => 'text/plain',
                    },
                    hu => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] létrehozva',
                        Body =>
                            'Létrejött a következő munkamegrendelés: <OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>.'
                            . $WorkOrderInfoAgentHu,
                        ContentType => 'text/plain',
                    },
                    nl => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] aangemaakt',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> is aangemaakt.'
        ...
        },
        {
            ...
            Message   => {
                Agent => {
                    de => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] aktualisiert',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> wurde aktualisiert.'
                            . $WorkOrderInfoAgentDe,
                        ContentType => 'text/plain',
                    },
                    en => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] updated',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> was updated.'
                            . $WorkOrderInfoAgentEn,
                        ContentType => 'text/plain',
                    },
                    hu => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] frissítve',
                        Body =>
                            'Frissült a következő munkamegrendelés: <OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>.'
                            . $WorkOrderInfoAgentHu,
                        ContentType => 'text/plain',
                    },
                    nl => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] bijgewerkt',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> is bijgewerkt.'
                            . $WorkOrderInfoAgentNl,
                        ContentType => 'text/plain',
                    },
                },
        ...
        },
        {
            ...
            Message   => {
                Agent => {
                    de => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] <OTOBO_LINK_Object> verknüpft',
                        Body =>
                            '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> wurde mit einem <OTOBO_LINK_Object> verknüpft.'
                            . $ChangeInfoAgentDe,
                        ContentType => 'text/plain',
                    },
                    en => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] <OTOBO_LINK_Object> linked',
                        Body =>
                            '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> was linked to a <OTOBO_LINK_Object> .'
                            . $ChangeInfoAgentEn,
                        ContentType => 'text/plain',
                    },
                    hu => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] <OTOBO_LINK_Object> összekapcsolva',
                        Body =>
                            'A(z) <OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> változást összekapcsolták egy <OTOBO_LINK_Object> objektummal.'
                            . $ChangeInfoAgentHu,
                        ContentType => 'text/plain',
                    },
                    nl => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] <OTOBO_LINK_Object> linked',
                        Body =>
                            '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> is gekoppeld aan een <OTOBO_LINK_Object> .'
                            . $ChangeInfoAgentNl,
                        ContentType => 'text/plain',
                    },
                },
                Customer => {
                    ...
                    nl => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] <OTOBO_LINK_Object> gekoppeld',
                        Body =>
                            '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> is gekoppeld aan een <OTOBO_LINK_Object> .'
                            . $ChangeInfoCustomerNl,
                        ContentType => 'text/plain',
        ...
        },
        {
            ...
            Message   => {
                Agent => {
                    de => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] geplante Startzeit erreicht',
                        Body =>
                            '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> hat die geplante Startzeit erreicht.'
                            . $ChangeInfoAgentDe,
                        ContentType => 'text/plain',
                    },
                    en => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] Planned Start Time reached',
                        Body =>
                            '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> has reached its Planned Start Time.'
                            . $ChangeInfoAgentEn,
                        ContentType => 'text/plain',
                    },
                    hu => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] tervezett kezdési idő elérve',
                        Body =>
                            'A(z) <OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> változás elérte a tervezett kezdési idejét.'
                            . $ChangeInfoAgentHu,
                        ContentType => 'text/plain',
                    },
                    nl => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] geplande starttijd bereikt',
                        Body =>
                            '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> heeft de geplande starttijd bereikt.'
                            . $ChangeInfoAgentNl,
                        ContentType => 'text/plain',
                    },
                },
        ...
        },
        {
            ...
            Message   => {
                Agent => {
                    de => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] geplante Endzeit erreicht',
                        Body =>
                            '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> hat die geplante Endzeit erreicht.'
                            . $ChangeInfoAgentDe,
                        ContentType => 'text/plain',
                    },
                    en => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] Planned End Time reached',
                        Body =>
                            '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> has reached its Planned End Time.'
                            . $ChangeInfoAgentEn,
                        ContentType => 'text/plain',
                    },
                    hu => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] tervezett befejezési idő elérve',
                        Body =>
                            'A(z) <OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> változás elérte a tervezett befejezési idejét.'
                            . $ChangeInfoAgentHu,
                        ContentType => 'text/plain',
                    },
                    nl => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] geplande eindttijd bereikt',
                        Body =>
                            '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> heeft de geplande eindtijd bereikt.'
                            . $ChangeInfoAgentNl,
                        ContentType => 'text/plain',
                    },
                },
                Customer => {
                    ...
                    nl => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] geplande eindtijd bereikt',
                        Body =>
                            '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> heeft de geplande eindtijd bereikt.'
                            . $ChangeInfoCustomerNl,
                        ContentType => 'text/plain',
        ...
        },
        {
            ...
            Message   => {
                Agent => {
                    de => {
                        Subject => '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] begonnen',
                        Body    => '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> wurde begonnen.'
                            . $ChangeInfoAgentDe,
                        ContentType => 'text/plain',
                    },
                    en => {
                        Subject => '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] started',
                        Body    => '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> has started.'
                            . $ChangeInfoAgentEn,
                        ContentType => 'text/plain',
                    },
                    hu => {
                        Subject => '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] elkezdődött',
                        Body =>
                            'Elkezdődött a következő változás: <OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>.'
                            . $ChangeInfoAgentHu,
                        ContentType => 'text/plain',
                    },
                    nl => {
                        Subject => '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] gestart',
                        Body    => '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> is gestart.'
                            . $ChangeInfoAgentNl,
                        ContentType => 'text/plain',
                    },
                },
        ...
        },
        {
            ...
            Message   => {
                Agent => {
                    de => {
                        Subject => '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] abgeschlossen',
                        Body    => '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> wurde abgeschlossen.'
                            . $ChangeInfoAgentDe,
                        ContentType => 'text/plain',
                    },
                    en => {
                        Subject => '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] finished',
                        Body    => '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> was finished.'
                            . $ChangeInfoAgentEn,
                        ContentType => 'text/plain',
                    },
                    hu => {
                        Subject => '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] befejeződött',
                        Body =>
                            'Befejeződött a következő változás: <OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>.'
                            . $ChangeInfoAgentHu,
                        ContentType => 'text/plain',
                    },
                    nl => {
                        Subject => '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] afgerond',
                        Body    => '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> is afgerond.'
                            . $ChangeInfoAgentNl,
                        ContentType => 'text/plain',
                    },
                },
        ...
        },
        {
            ...
            Message   => {
                Agent => {
                    de => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] Gewünschte Fertigstellungszeit erreicht',
                        Body =>
                            '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> hat die gewünschte Fertigstellungszeit erreicht.'
                            . $ChangeInfoAgentDe,
                        ContentType => 'text/plain',
                    },
                    en => {
                        Subject => '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] requested time reached',
                        Body =>
                            '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> has reached its requested time.'
                            . $ChangeInfoAgentEn,
                        ContentType => 'text/plain',
                    },
                    hu => {
                        Subject => '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] kért idő elérve',
                        Body =>
                            'A(z) <OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> változás elérte a kért idejét.'
                            . $ChangeInfoAgentHu,
                        ContentType => 'text/plain',
                    },
                    nl => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] aangevraagd tijdstip bereikt',
                        Body =>
                            '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> heeft het aangevraagde tijdstip bereikt.'
                            . $ChangeInfoAgentNl,
                        ContentType => 'text/plain',
                    },
                },
        ...
        },
        {
            ...
            Message   => {
                Agent => {
                    de => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] geplante Startzeit erreicht',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> hat die geplante Startzeit erreicht.'
                            . $WorkOrderInfoAgentDe,
                        ContentType => 'text/plain',
                    },
                    en => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] Planned Start Time reached',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> has reached the Planned Start Time.'
                            . $WorkOrderInfoAgentEn,
                        ContentType => 'text/plain',
                    },
                    hu => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] tervezett kezdési idő elérve',
                        Body =>
                            'A(z) <OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> munkamegrendelés elérte a tervezett kezdési idejét.'
                            . $WorkOrderInfoAgentHu,
                        ContentType => 'text/plain',
                    },
                    nl => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] geplande starttijd bereikt',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> heeft de geplande starttijd bereikt.'
                            . $WorkOrderInfoAgentNl,
                        ContentType => 'text/plain',
                    },
                },
        ...
        },
        {
            ...
            Message   => {
                Agent => {
                    de => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] geplante Endzeit erreicht',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> hat die geplante Endzeit erreicht.'
                            . $WorkOrderInfoAgentDe,
                        ContentType => 'text/plain',
                    },
                    en => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] Planned End Time reached',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> has reached the Planned End Time.'
                            . $WorkOrderInfoAgentEn,
                        ContentType => 'text/plain',
                    },
                    hu => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] tervezett befejezési idő elérve',
                        Body =>
                            'A(z) <OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> munkamegrendelés elérte a tervezett befejezési idejét.'
                            . $WorkOrderInfoAgentHu,
                        ContentType => 'text/plain',
                    },
                    nl => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] geplande eindttijd bereikt',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> heeft de geplande eindtijd bereikt.'
                            . $WorkOrderInfoAgentNl,
                        ContentType => 'text/plain',
                    },
                },
                Customer => {
                    ...
                    nl => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] geplande eindtijd bereikt',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> heeft de geplande eindtijd bereikt.'
                            . $WorkOrderInfoCustomerNl,
                        ContentType => 'text/plain',
        ...
        },
        {
            ...
            Message   => {
                Agent => {
                    de => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] begonnen',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> wurde begonnen.'
                            . $WorkOrderInfoAgentDe,
                        ContentType => 'text/plain',
                    },
                    en => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] started',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> has started.'
                            . $WorkOrderInfoAgentEn,
                        ContentType => 'text/plain',
                    },
                    hu => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] elkezdődött',
                        Body =>
                            'Elkezdődött a következő munkamegrendelés: <OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>.'
                            . $WorkOrderInfoAgentHu,
                        ContentType => 'text/plain',
                    },
                    nl => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] gestart',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> is gestart.'
                            . $WorkOrderInfoAgentNl,
                        ContentType => 'text/plain',
                    },
                },
        ...
        },
        {
            ...
            Message   => {
                Agent => {
                    de => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] abgeschlossen',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> wurde abgeschlossen.'
                            . $WorkOrderInfoAgentDe,
                        ContentType => 'text/plain',
                    },
                    en => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] finished',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> was finished.'
                            . $WorkOrderInfoAgentEn,
                        ContentType => 'text/plain',
                    },
                    hu => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] befejeződött',
                        Body =>
                            'Befejeződött a következő munkamegrendelés: <OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>.'
                            . $WorkOrderInfoAgentHu,
                        ContentType => 'text/plain',
                    },
                    nl => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber>] afgerond',
                        Body =>
                            '<OTOBO_CONFIG_ITSMWorkOrder::Hook><OTOBO_CHANGE_ChangeNumber>-<OTOBO_WORKORDER_WorkOrderNumber> is afgerond.'
                            . $WorkOrderInfoAgentNl,
                        ContentType => 'text/plain',
                    },
                },
        ...
        },
        {
            ...
            Message   => {
                Agent => {
                    de => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] Aktions-Ausführung <OTOBO_CONDITION_ActionResult>',
                        Body =>
                            '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> Aktions-Ausführung <OTOBO_CONDITION_ActionResult>.'
                            . "\n"
                            . "\n"
                            ...
                            . "Aktueller Change Status: <OTOBO_CHANGE_ChangeState>\n"
                            . "\n"
                            . "Condition ID: <OTOBO_CONDITION_ConditionID>\n"
                            . "Condition Name: <OTOBO_CONDITION_ConditionName>\n"
                            . "\n"
                            . "Action ID: <OTOBO_CONDITION_ActionID>\n"
                            . "Aktions-Ausführung: <OTOBO_CONDITION_ActionResult>\n"
                            . "\n"
                            . "<OTOBO_CONFIG_HttpType>://<OTOBO_CONFIG_FQDN>/<OTOBO_CONFIG_ScriptAlias>index.pl?Action=AgentITSMChangeZoom;ChangeID=<OTOBO_CHANGE_ChangeID>\n"
                            . "\n"
                            . "-- <OTOBO_CONFIG_NotificationSenderName>\n",
                    ...
                    en => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] Action execution <OTOBO_CONDITION_ActionResult>',
                        Body =>
                            '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> Action execution <OTOBO_CONDITION_ActionResult>.'
                            . "\n"
                            . "\n"
                            ...
                            . "\n"
                            . "Action ID: <OTOBO_CONDITION_ActionID>\n"
                            . "Action execution: <OTOBO_CONDITION_ActionResult>\n"
                            . "\n"
                            . "<OTOBO_CONFIG_HttpType>://<OTOBO_CONFIG_FQDN>/<OTOBO_CONFIG_ScriptAlias>index.pl?Action=AgentITSMChangeZoom;ChangeID=<OTOBO_CHANGE_ChangeID>\n"
                            . "\n"
                            . "-- <OTOBO_CONFIG_NotificationSenderName>\n",
                    ...
                    hu => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] művelet-végrehajtás: <OTOBO_CONDITION_ActionResult>',
                        Body =>
                            '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> művelet-végrehajtás: <OTOBO_CONDITION_ActionResult>.'
                            . "\n"
                            . "\n"
                            ...
                            . "Jelenlegi változásállapot: <OTOBO_CHANGE_ChangeState>\n"
                            . "\n"
                            . "Feltételazonosító: <OTOBO_CONDITION_ConditionID>\n"
                            . "Feltételnév: <OTOBO_CONDITION_ConditionName>\n"
                            . "\n"
                            . "Műveletazonosító: <OTOBO_CONDITION_ActionID>\n"
                            . "Művelet-végrehajtás: <OTOBO_CONDITION_ActionResult>\n"
                            . "\n"
                            . "<OTOBO_CONFIG_HttpType>://<OTOBO_CONFIG_FQDN>/<OTOBO_CONFIG_ScriptAlias>index.pl?Action=AgentITSMChangeZoom;ChangeID=<OTOBO_CHANGE_ChangeID>\n"
                            . "\n"
                            . "-- <OTOBO_CONFIG_NotificationSenderName>\n",
                    ...
                    nl => {
                        Subject =>
                            '[<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber>] Actie uitgevoerd <OTOBO_CONDITION_ActionResult>',
                        Body =>
                            '<OTOBO_CONFIG_ITSMChange::Hook><OTOBO_CHANGE_ChangeNumber> Actie uitgevoerd <OTOBO_CONDITION_ActionResult>.'
                            . "\n"
                            . "\n"
                            ...
                            . "Actuele change-status: <OTOBO_CHANGE_ChangeState>\n"
                            . "\n"
                            . "Conditie-ID: <OTOBO_CONDITION_ConditionID>\n"
                            . "Conditie naam: <OTOBO_CONDITION_ConditionName>\n"
                            . "\n"
                            . "Actie-ID: <OTOBO_CONDITION_ActionID>\n"
                            . "Actie resultaat: <OTOBO_CONDITION_ActionResult>\n"
                            . "\n"
                            . "<OTOBO_CONFIG_HttpType>://<OTOBO_CONFIG_FQDN>/<OTOBO_CONFIG_ScriptAlias>index.pl?Action=AgentITSMChangeZoom;ChangeID=<OTOBO_CHANGE_ChangeID>\n"
                            . "\n"
                            . "-- <OTOBO_CONFIG_NotificationSenderName>\n",
