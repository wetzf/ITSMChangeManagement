...
$Selenium->RunTest(
    sub {
        ...
        $Selenium->find_element("//a[contains(\@href, \'Action=AgentITSMWorkOrderHistory;WorkOrderID=$WorkOrderID')]")->click();
        ...
        $Selenium->find_element("//a[contains(\@href, \'Action=AgentITSMWorkOrderHistoryZoom;HistoryEntryID=' )]")->VerifiedClick();
